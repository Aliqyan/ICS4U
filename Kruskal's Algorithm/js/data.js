...
var commands = {
    // edge lines
    "a-b": [0, true, "dl", v.a.x, v.a.y, v.b.x, v.b.y, baseCol], // A-B
    "a-c": [0, true, "dl", v.a.x, v.a.y, v.c.x, v.c.y, baseCol], // A-C
    "a-e": [0, true, "dl", v.a.x, v.a.y, v.e.x, v.e.y, baseCol], // A-E
    "a-f": [0, true, "dl", v.a.x, v.a.y, v.f.x, v.f.y, baseCol], // A-F
    "b-c": [0, true, "dl", v.b.x, v.b.y, v.c.x, v.c.y, baseCol], // B-C
    "b-d": [0, true, "dl", v.b.x, v.b.y, v.d.x, v.d.y, baseCol], // B-D
    "c-d": [0, true, "dl", v.c.x, v.c.y, v.d.x, v.d.y, baseCol], // C-D
    "c-e": [0, true, "dl", v.c.x, v.c.y, v.e.x, v.e.y, baseCol], // C-E
    "f-g": [0, true, "dl", v.f.x, v.f.y, v.g.x, v.g.y, baseCol], // F-G
    "e-f": [0, true, "dl", v.e.x, v.e.y, v.f.x, v.f.y, baseCol], // E-F
    "e-g": [0, true, "dl", v.e.x, v.e.y, v.g.x, v.g.y, baseCol], // E-G
    "d-g": [0, true, "dl", v.d.x, v.d.y, v.g.x, v.g.y, baseCol], // D-G
    //edge weights
    "a-b val": [0, true, "t", "2", 30, (v.a.x + v.b.x) / 2 - 5, (v.a.y + v.b.y) / 2 - 10, baseCol], // A-B
    "a-c val": [0, true, "t", "11", 30, (v.a.x + v.c.x) / 2, (v.a.y + v.c.y) / 2 - 10, baseCol], // A-C
    "a-e val": [0, true, "t", "6", 30, (v.a.x + v.e.x) / 2, (v.a.y + v.e.y) / 2 + 45, baseCol], // A-E
    "a-f val": [0, true, "t", "4", 30, (v.a.x + v.f.x) / 2 - 25, (v.a.y + v.f.y) / 2 + 15, baseCol], // A-F
    "b-c val": [0, true, "t", "3", 30, (v.b.x + v.c.x) / 2 - 25, (v.b.y + v.c.y) / 2, baseCol], // B-C
    "b-d val": [0, true, "t", "9", 30, (v.b.x + v.d.x) / 2, (v.b.y + v.d.y) / 2 - 10, baseCol], // B-D
    "c-d val": [0, true, "t", "7", 30, (v.c.x + v.d.x) / 2, (v.c.y + v.d.y) / 2 - 5, baseCol], // C-D
    "c-e val": [0, true, "t", "2", 30, (v.c.x + v.e.x) / 2 + 15, (v.c.y + v.e.y) / 2 + 30, baseCol], // C-E
    "f-g val": [0, true, "t", "12", 30, (v.f.x + v.g.x) / 2, (v.f.y + v.g.y) / 2 + 35, baseCol], // F-G
    "e-f val": [0, true, "t", "7", 30, (v.e.x + v.f.x) / 2 + 25, (v.e.y + v.f.y) / 2 + 15, baseCol], // E-F
    "e-g val": [0, true, "t", "8", 30, (v.e.x + v.g.x) / 2, (v.e.y + v.g.y) / 2 - 10, baseCol], // E-G
    "d-g val": [0, true, "t", "5", 30, (v.d.x + v.g.x) / 2 + 20, (v.d.y + v.g.y) / 2 - 5, baseCol], // D-G
    // vertex
    "a-circle": [0, true, "dc", v.a.x, v.a.y, 20, "#000"], // A
    "b-circle": [0, true, "dc", v.b.x, v.b.y, 20, "#000"], // B
    "c-circle": [0, true, "dc", v.c.x, v.c.y, 20, "#000"], // C
    "d-circle": [0, true, "dc", v.d.x, v.d.y, 20, "#000"], // D
    "e-circle": [0, true, "dc", v.e.x, v.e.y, 20, "#000"], // E
    "f-circle": [0, true, "dc", v.f.x, v.f.y, 20, "#000"], // F
    "g-circle": [0, true, "dc", v.g.x, v.g.y, 20, "#000"], // G
    // vertex label
    "a-letter": [0, true, "t", "A", 30, v.a.x, v.a.y + 10, baseCol],
    "b-letter": [0, true, "t", "B", 30, v.b.x, v.b.y + 10, baseCol],
    "c-letter": [0, true, "t", "C", 30, v.c.x, v.c.y + 10, baseCol],
    "d-letter": [0, true, "t", "D", 30, v.d.x, v.d.y + 10, baseCol],
...
var changes = [
    ...
    //a-b
    [
        ["a-bTable", [0, false, "t", "A -- B", 25, tableX, tableY + 0 * spacer, selectCol]],
        ["a-b", [0, false, "dl", v.a.x, v.a.y, v.b.x, v.b.y, selectCol]],
    ...
    [
        ...
        ["a-b", [0, false, "dl", v.a.x, v.a.y, v.b.x, v.b.y, goodCol]],
        ["a-b val", [0, false, "t", "2", 30, (v.a.x + v.b.x) / 2 - 5, (v.a.y + v.b.y) / 2 - 10, goodCol]],
    ],
    //e-c
    [
        ["tableText", []],
        ["e-cTable", [0, false, "t", "E -- C", 25, tableX, tableY + 1 * spacer, selectCol]], // E-C
        ["c-e", [0, false, "dl", v.c.x, v.c.y, v.e.x, v.e.y, selectCol]], // C-E
